...
function Tr() {
    ...
    if (lang=='RU') {
      ...
      h2.innerHTML='Чтобы начать заниматся выберите режим';
      tran('Английская', 'Русская', 'цифры','Три минуты&#160;&#160;раскладка:','250 Символов&#160;&#160;&#160;раскладка:')
      but.innerHTML="Далее";
    }
    if (lang=='UK') {
        T.innerHTML='Вибір режиму та розкладки'
      h2.innerHTML='Щоб почати займатися, виберіть режим';
      tran('Англійська', 'Російська', 'цифри','Три хвилини&#160;&#160;раскладка:','250 Символів&#160;&#160;&#160;розкладка:')
      but.innerHTML="Далі";
    }
    if (lang=='EN') {
    ...
    if (lang=='DE') {
        T.innerHTML='Auswählen eines Modus und Layouts'
      h2.innerHTML='Um mit dem Training zu beginnen, wählen Sie einen Modus';
      tran('Englisch', 'Russisch', 'zahlen','Drei Minuten&#160;&#160;layout:','250 Zeichen&#160;&#160;&#160;layout:')
