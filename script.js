...
let UserLang = 0;
if (lang==null) {
            if (window.browserLang=='ru'||window.navigator.language=='ru') {
                leng.value='1'
                UserLang=1
            }
            if (window.browserLang=='uk'||window.navigator.language=='uk') {
                leng.value='3'
                UserLang=1
            }if (window.browserLang=='de'||window.navigator.language=='de') {
                leng.value='4'
                UserLang=1
            }
            if(UserLang==0){
